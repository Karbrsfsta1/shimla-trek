...
const CONTACT_NOTE = (
  <div className="mb-8 rounded-lg border border-mountain/30 bg-mountain/5 p-4 text-sm text-gray-700">
    <p className="font-medium text-mountain">Contact Us</p>
    <p className="mt-1">
      Email{" "}
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mt-8">
        ...
        <ul className="ml-5 mt-2 list-disc space-y-1 text-gray-700">
          <li>WhatsApp: <a href="https://wa.me/917876803910" target="_blank" rel="noreferrer" className="text-forest hover:underline">+91 78768 03910</a></li>
          <li>Email: <a href="mailto:kforkartikbforbhardwaj@gmail.com" className="text-forest hover:underline">kforkartikbforbhardwaj@gmail.com</a></li>
        </ul>
      </section>
    </div>
  );
