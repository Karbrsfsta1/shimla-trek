    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            Email: <a href="mailto:kforkartikbforbhardwaj@gmail.com" className="text-forest hover:underline">kforkartikbforbhardwaj@gmail.com</a><br />
            WhatsApp: <a href="https://wa.me/917876803910" target="_blank" rel="noreferrer" className="text-forest hover:underline">+91 78768 03910</a>
          </p>
        </section>
      </div>
    </div>
